...
<body>
    <div class="structure">
        ...
        <div class="content-display">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('admin.handle.view', ['model' => 'events', 'action' => 'create']) }}" class="btn btn-success">
                    ...
                    <tbody id="category-table-body">
                        @forelse ($records as $record)
                            <tr class="category-row">
                                ...
                                <td>
                                    <a href="{{ route('admin.handle.view', ['model' => 'events', 'action' => 'edit', 'target' => $record->id]) }}" class="btn btn-sm btn-warning me-1">
                                        <i class="bi bi-pencil-square"></i> Editar
                                    </a>

                                    <form action="{{ route('admin.handle.delete', ['model' => 'events', 'target' => $record->id]) }}" method="POST" class="d-inline-block" onsubmit="return confirm('¿Estás seguro de eliminar esta categoría?')">
                                        @csrf
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-muted text-center">No hay categorías registradas.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <script>
        ...
        const baseUrl       = "{{ route('admin.handle.view', ['model' => 'events']) }}";
