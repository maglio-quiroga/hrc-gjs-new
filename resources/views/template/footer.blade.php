                    ...
                    <div class="row d-flex flex-row justify-content-around">
                        <div class="col-lg-3 footer_col">
                            <div class="footer_section footer_about">
                                <div class="footer_title mb-3 temp_1b">Ubicación</div>
                        ...
                        <div class="col-lg-3 footer_col">
                            <div class="row d-flex flex-row justify-content-around">
                                <div class="footer_section footer_contact">
                                    <div class="footer_title mb-3 temp_1b">Contacto</div>
                            ...
                            <div class="row d-flex flex-row justify-content-around">
                                <div class="footer_social">
                                    <div class="footer_title mb-3 temp_1b">Redes Sociales</div>
                                    <ul >
                                        ...
                                        <li><a
                                                href="https://www.instagram.com/hospitalregionalcopiapo/"><i
                                                    class="fa fa-instagram temp_1e" aria-hidden="true"></i></a></li>
                                        <li><a href="https://x.com/hospitalcopiapo/"><i class="fa fa-twitter temp_1f"
                                                    aria-hidden="true"></i></a></li>
                                        <li><a href="https://www.youtube.com/@hospitalregionalcopiaposan9695"><i
                                                        class="fa fa-youtube-play temp_1f" aria-hidden="true"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
