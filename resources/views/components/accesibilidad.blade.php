<div class="position-fixed bottom-0 end-0 m-3 accesibleBlade_1">
    ...
    <div id="accessibilityMenu" class="accMenu bg-white border rounded shadow-sm p-3 mt-2 d-none position-absolute end-0 accesibleBlade_2">
