...
<div class="card text-center">
    <div class="card-header">
        <h3 class="card-title text-color">ADMINISTRADOR: Visualización de las Categorias de Noticias</h3>
    </div>
    <div class="card-body">
        <div>
