...
<div class="card text-center">
    <div class="card-header ">
        <h3 class="card-title text-color">ADMINISTRADOR: Visualización de Servicios</h3>
    </div>
    <div class="card-body">
            <div>
                <a class="btn btn-secondary btn-block" href="{{ route('service.create') }}">Crear Nuevo Servicio</a>
