    ...
    <div class="hidden sm:flex sm:items-center sm:ml-6">
        <x-dropdown align="left" width="48" class="text-left">
            <x-slot name="trigger">
                ...
                <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                    ...
                    <div><span class="fas fa-blog"></span>Programas</div>
            ...
            <x-slot name="content" class="fill-current h-4 w-40">
                @include('dashboard.partials.nav-header-main.nav-header-main-menu-course')             
            </x-slot>
        ...
        <x-dropdown align="left" width="48" class="text-left">
            <x-slot name="trigger">
                ...
                <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                    ...
                    <div><span class="fas fa-blog"></span>Estadísticas</div>
            ...
            <x-slot name="content" class="fill-current h-4 w-40">
                @include('dashboard.partials.nav-header-main.nav-header-main-menu-statistics')             
            </x-slot>
        ...
        <x-dropdown align="left" width="48" class="text-left">
            <x-slot name="trigger">
                ...
                <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                    <div class="mr-3" style="color: #4EA8DE;">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>    
                    </div>
                    <div><span class="fas fa-blog"></span>Administrador</div>
            ...
            <x-slot name="content" class="fill-current h-4 w-40">
                @include('dashboard.partials.nav-header-main.nav-header-main-menu-administrator')             
            </x-slot>
