<x-dropdown-link :href="route('post.index')" :active="request()->routeIs('post.index')" class="icon-menu icon-menu-hover-blue">
...
<x-dropdown-link :href="route('service.index')" :active="request()->routeIs('category.index')" class="icon-menu icon-menu-hover-blue">
    <div class="mr-3 text-blue-600">
